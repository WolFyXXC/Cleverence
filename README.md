...
1. [Задача 1: Компрессия и декомпрессия строки](#задача-1-компрессия-и-декомпрессия-строки)
2. [Задача 2: Потокобезопасный сервер с Read/Write блокировками](#задача-2-потокобезопасный-сервер-с-readwrite-блокировками)
3. [Задача 3: Стандартизация лог-файлов](#задача-3-стандартизация-лог-файлов)

#📁 Структура проекта
```bash
Cleverence_tasks/
├── Task1/               # Компрессия/декомпрессия
...
 
 
## Задача 2: Потокобезопасный сервер с Read/Write блокировками
...
 
## Задача 3: Консольная программа для стандартизации лог-файлов
